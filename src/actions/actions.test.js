...
import defaultTestDetails from '../__test__/mocks/details-mock.json';
...
describe('recieve', () => {
  it('should create action for receiving locations', () => {
    const testAction = {
      type: types.DETAIL,
      detail: mockResponse.data.listing,
    };

    expect(actions.receiveDetails(defaultTestDetails, mockResponse)).toEqual(testAction);
  });
});
